...
public class ShirtOutlineColorStorage : MonoBehaviour
{
    public static ShirtOutlineColorStorage Instance;

    private const string ColorKey = "ShirtOutlineSavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("ShirtOutline");
