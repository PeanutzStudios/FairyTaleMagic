...
{
    public class FrontHairColor : MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("frontHairr");

            // Load the saved color when the game starts
            HairColorStorage.Instance.LoadColor();
        ...
        public void Open()
        {
            ...
            Open(HairColorStorage.Instance.SelectedColor);
        }
