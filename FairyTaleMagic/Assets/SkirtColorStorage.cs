...
public class SkirtColorOutlineStorage : MonoBehaviour
{
    public static SkirtColorOutlineStorage Instance;

    private const string ColorKey = "SkirtSavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("Skirt");
