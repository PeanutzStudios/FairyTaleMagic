...
public class SkirtOutlineStorage : MonoBehaviour
{
    public static SkirtOutlineStorage Instance;

    private const string ColorKey = "SkirtOutlineSavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("SkirtOutline");
