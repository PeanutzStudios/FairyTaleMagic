...
public class BGColorStorage : MonoBehaviour
{
    public static BGColorStorage Instance;

    private const string ColorKey = "SavedGBColor";  // Use a unique key for body color
    ...
    {
        GameObject[] bodyObjects = GameObject.FindGameObjectsWithTag("BGColor");
