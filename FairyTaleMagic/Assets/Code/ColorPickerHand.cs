...
{
    public class ColorPickerForBody : MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("Body");

            // Load the saved color when the game starts
            bodyColorStorage.Instance.LoadColor(); // Ensure color is loaded
            Color savedColor = bodyColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            Open(bodyColorStorage.Instance.SelectedColor); // Open with the saved color
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            bodyColorStorage.Instance.SaveColor(color);
