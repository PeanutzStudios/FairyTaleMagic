...
{
    public class ShirtOutlineColor : MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("ShirtOutline");

            // Load the saved color when the game starts
            ShirtOutlineColorStorage.Instance.LoadColor();
            Color savedColor = ShirtOutlineColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            ...
            Open(ShirtOutlineColorStorage.Instance.SelectedColor);
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            ShirtOutlineColorStorage.Instance.SaveColor(color);
