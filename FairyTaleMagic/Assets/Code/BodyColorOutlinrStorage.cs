...
public class bodyColorOutlineStorage : MonoBehaviour
{
    public static bodyColorOutlineStorage Instance;

    private const string ColorKey = "SavedBodyOutlineColor";  // Use a unique key for body color
    ...
    {
        GameObject[] bodyObjects = GameObject.FindGameObjectsWithTag("BodyOutline");
