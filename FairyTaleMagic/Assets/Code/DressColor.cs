...
namespace TS.ColorPicker
{
    public class DressColor : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("DressColor");

            // Load the saved color when the game starts
           DressColorStorage.Instance.LoadColor();
            Color savedColor = DressColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            ...
            Open(DressColorStorage.Instance.SelectedColor);
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            DressColorStorage.Instance.SaveColor(color);
