...
{
    public class SkirtColor: MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("Skirt");

            // Load the saved color when the game starts
        SkirtColorOutlineStorage .Instance.LoadColor();
            Color savedColor = SkirtColorOutlineStorage .Instance.SelectedColor;
        ...
        public void Open()
        {
            ...
            Open(SkirtColorOutlineStorage .Instance.SelectedColor);
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            SkirtColorOutlineStorage .Instance.SaveColor(color);
