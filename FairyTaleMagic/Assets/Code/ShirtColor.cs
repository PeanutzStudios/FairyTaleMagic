...
namespace TS.ColorPicker
{
    public class ShirtColor : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("ShirtColor");

            // Load the saved color when the game starts
           ShirtColorStorage.Instance.LoadColor();
            Color savedColor = ShirtColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            ...
            Open(ShirtColorStorage.Instance.SelectedColor);
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            ShirtColorStorage.Instance.SaveColor(color);
