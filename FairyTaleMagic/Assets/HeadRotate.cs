...
{
    public static HeadRotate Instance; // Singleton for hand controller
    ...
    void Start()
    {
        ...
        handInstance = GameObject.FindWithTag("Head");

        if (handInstance == null)
        {
            Debug.LogError("Hand instance not found in the scene! Ensure the object exists and has the 'RHand' tag.");
            return;
        }
    ...
    {
        // Update target rotation based on slider value and invert the direction
