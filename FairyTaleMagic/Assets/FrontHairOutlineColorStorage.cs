...
public class FrontHairOutlineStorage : MonoBehaviour
{
    public static FrontHairOutlineStorage Instance;

    private const string ColorKey = "SavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("frontHairoutline");
