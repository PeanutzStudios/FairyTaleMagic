...
{
    public class ColorPickerForBackground : MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            colorPickerObjects = GameObject.FindGameObjectsWithTag("BGColor");

            // Load the saved color when the game starts
            BGColorStorage.Instance.LoadColor();
            Color savedColor = BGColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            ...
            Open(BGColorStorage.Instance.SelectedColor);
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            BGColorStorage.Instance.SaveColor(color);
