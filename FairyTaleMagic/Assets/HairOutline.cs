...
{
    public class ColorPickerHairOutline : MonoBehaviour
    {
        #region Variables
        ...
        private void Start()
        {
            ...
            HairColorStorage.Instance.LoadColor(); // Ensure color is loaded
            Color savedColor = HairColorStorage.Instance.SelectedColor;
        ...
        public void Open()
        {
            Open(HairColorStorage.Instance.SelectedColor); // Open with the saved color
        }
        ...
        private void SetCurrentColor(Color color)
        {
            ...
            HairColorStorage.Instance.SaveColor(color);
