...
public class ShirtColorStorage : MonoBehaviour
{
    public static ShirtColorStorage Instance;

    private const string ColorKey = "ShirtSavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("ShirtColor");
