...
public class DressColorStorage : MonoBehaviour
{
    public static DressColorStorage Instance;

    private const string ColorKey = "DressSavedColor";
    ...
    {
        GameObject[] hairObjects = GameObject.FindGameObjectsWithTag("DressColor");
    ...
    {
        GameObject[] uiHairPreviews = GameObject.FindGameObjectsWithTag("DressColor");
